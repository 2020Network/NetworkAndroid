...
import com.example.studygorup.DTO.DeleteGroup;
...
public class PostContentActivity2 extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback, View.OnClickListener {
    ...
    TextView postBtn,deleteBtn, cancelBtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_content2);
        ...
        sAddress = getIntent().getStringExtra("groupLocation");
        //endregion
        ...
        editTitle.setText(getIntent().getStringExtra("groupTitle"));
        editInfo.setText(getIntent().getStringExtra("groupContent"));
        editMinY.setText(getIntent().getStringExtra("groupAge1"));
        editMaxY.setText(getIntent().getStringExtra("groupAge2"));
...
/*
        val title : String,
               ...
               */
                ...
                groupAPI.mygroupUpdate(
                        new GroupUpdate(editTitle.getText().toString(),
                                ...
                                strField,
                                getIntent().getIntExtra("groupID",0))).enqueue(new Callback<ResponseGroupID>() {
                    @Override
            ...
            case R.id.cancelBtn:
                ...
                break;
            case R.id.deleteBtn:
                GroupAPI group = new RetrofitHelper().getGroupAPI();
                group.groupDelete(
                        new DeleteGroup(getIntent().getIntExtra("groupID",0))).enqueue(new Callback<ResponseGroupID>() {
                    @Override
                    public void onResponse(Call<ResponseGroupID> call, Response<ResponseGroupID> response) {
                        if (response.isSuccessful()){
                            finish();
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(this, REQUIRED_PERMISSIONS[0])) {
                ...
                Snackbar.make(mLayout, "이 앱을 실행하려면 위치 접근 권한이 필요합니다.",
                    ...
                    public void onClick(View view) {
                        ...
                        ActivityCompat.requestPermissions( PostContentActivity2.this, REQUIRED_PERMISSIONS, PERMISSIONS_REQUEST_CODE );
                    }
                }).show();
    ...
    private void showDialogForLocationServiceSetting() {
        AlertDialog.Builder builder = new AlertDialog.Builder(PostContentActivity2.this);
